...
import com.kmutnb_user_cli.newarchitecture.MainApplicationReactNativeHost;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
         ...
         */
        Class<?> aClass = Class.forName("com.kmutnb_user_cli.ReactNativeFlipper");
        aClass
